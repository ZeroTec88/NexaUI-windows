...
/// <summary>
/// A themed WinForms <see cref="FlowLayoutPanel"/> provided by NexaUI. Inherits the
/// native <see cref="FlowLayoutPanel"/> so all layout, scrolling, docking, and designer
/// behavior is preserved. Adds a themed background, an optional border with rounded
/// corners, and full theme integration.
/// </summary>
[DefaultEvent(nameof(Paint))]
[DefaultProperty(nameof(FlowDirection))]
public class NexaFlowPanel : FlowLayoutPanel
{
    private int _cornerRadiusDips = 2;
    private int _borderThicknessDips = 1;
    private bool _borderEnabled;

    /// <summary>Initializes a new instance of the <see cref="NexaFlowPanel"/> class.</summary>
    public NexaFlowPanel()
    {
        SetStyle(
