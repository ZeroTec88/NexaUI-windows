...
public sealed class LightTheme : NexaThemeBase
{
    ...
    private static NexaPalette BuildPalette() => new(
        ...
        inputBorder: new NexaSemanticColor(Color.FromArgb(206, 212, 220)),
        inputBackground: new NexaSemanticColor(Color.White),
        inputPlaceholder: new NexaSemanticColor(Color.FromArgb(150, 156, 170)),
